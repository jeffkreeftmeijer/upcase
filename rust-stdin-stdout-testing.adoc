...
.`src/main.rs`
```rust
include::https://raw.githubusercontent.com/jeffkreeftmeijer/upcase/3b038e6b0845fa7dc4047d64c23b2344d9b7caed/src/main.rs[]
```
====
...
.`src/lib.rs`
```rust
include::https://raw.githubusercontent.com/jeffkreeftmeijer/upcase/64534182120b1eb5eace92f18bb4e8cdb4cf25fd/src/lib.rs[]
```
====
...
.`src/lib.rs`
```rust
include::https://raw.githubusercontent.com/jeffkreeftmeijer/upcase/bedb37f0ac42921f0ee60afd24d34113d25fca04/src/lib.rs[lines=1..13]
```
====
...
.`src/main.rs`
```
include::https://raw.githubusercontent.com/jeffkreeftmeijer/upcase/7a9db42020d736aac278e41377dd16b0fa96607b/src/main.rs[]
```
====
